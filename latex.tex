...
Let $\vec{V}$ be a finite dimensional vector space over the field $\mathbbf{F}$ and let $\cbrak{\vec{v_1},\vec{v_2},\hdots,\vec{v_n}}$ be a basis for $\vec{V}$.Then there exists a unique dual basis $\cbrak{f_1,f_2,\hdots,f_n}$ for $\vec{V}^*$ such that
\begin{align}
